...
const app = fixture("astro-islands");
const expectations = readExpectations(app);

test.describe("Astro builds a static site with a React island", { tag: "@quick" }, () => {
...
test.describe("Astro builds a static site with a React island, byte-level proof", () => {
