...
const app = fixture("cli-vanilla-esm");
const expectations = readExpectations(app);

test.describe("the CLI obfuscates a bundler-free ES module graph", { tag: "@quick" }, () => {
...
test.describe("the CLI obfuscates a bundler-free ES module graph, byte-level proof", () => {
