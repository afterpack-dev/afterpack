...
// A canonical AfterPack directive span. Next.js's SWC transpile + bundler
// minifier strips this comment before AfterPack runs
// (framework-integration.md §9.2, Next.js row); the directive-capture flow
